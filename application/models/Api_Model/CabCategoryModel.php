...
Class CabCategoryModel extends CI_Model {
    ...
    function getCab2(){
        ...
        $data = $this->db->query("SELECT * FROM `driver` as d,user_current_locations as uc,cab as c,`cab-category` as cc WHERE 
                            driver_current_status = 'online'
                            AND
                            d.id = uc.user_id
                            AND
                            uc.user_type = 'Driver'
                            ...
                            d.id = c.driver_id
                            AND
                            c.cab_type_name = cc.name")->result_array();
        return $data;
    }
