...
class MY_Model extends CI_Model
{
    ...
    public function AuditTrailLog($user_name, $user_id, $description, $action_url = NULL, $user_role = NULL, $email= NULL) {
        
        $audittraildata["AuditTrail"]["user_name"] = $user_name;
        ...
        $audittraildata["AuditTrail"]["action_url"] = $action_url;
        $audittraildata["AuditTrail"]["user_role"] = $user_role;
        $audittraildata["AuditTrail"]["email"] = $email;
        $audittraildata["AuditTrail"]["created_date"] = date("Y-m-d H:i:s");
        $description = preg_replace("/'/", "''", $description);
        $audittraildata["AuditTrail"]["description"] = $description;

        $this->load->model('ActivityLog_Model');
        $this->ActivityLog_Model->saveLog($audittraildata);
    }
}