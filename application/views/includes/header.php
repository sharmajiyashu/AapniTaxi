<div class="page-header navbar navbar-fixed-top">
			<div class="page-header-inner ">
				...
				<div class="page-logo">
					<a href="index-2.html">
						<img alt="" src="<?php echo base_url(); ?>source/assets/img/logo.png">
						<span class="logo-default">Aapni Taxi</span> </a>
				</div>
				<!-- logo end -->
				...
				<div class="top-menu">
					<ul class="nav navbar-nav pull-right">
						...
						<!--					<a href="#">-->
						<!--						<span class="photo">-->
						<!--							<img src="<?php echo base_url(); ?>source/assets/img/user/user2.jpg" class="img-circle"-->
						<!--								alt=""> </span>-->
						<!--						<span class="subject">-->
						...
						<!--					<a href="#">-->
						<!--						<span class="photo">-->
						<!--							<img src="<?php echo base_url(); ?>source/assets/img/user/user3.jpg" class="img-circle"-->
						<!--								alt=""> </span>-->
						<!--						<span class="subject">-->
						...
						<!--					<a href="#">-->
						<!--						<span class="photo">-->
						<!--							<img src="<?php echo base_url(); ?>source/assets/img/user/user1.jpg" class="img-circle"-->
						<!--								alt=""> </span>-->
						<!--						<span class="subject">-->
						...
						<!--					<a href="#">-->
						<!--						<span class="photo">-->
						<!--							<img src="<?php echo base_url(); ?>source/assets/img/user/user8.jpg" class="img-circle"-->
						<!--								alt=""> </span>-->
						<!--						<span class="subject">-->
						...
						<!--					<a href="#">-->
						<!--						<span class="photo">-->
						<!--							<img src="<?php echo base_url(); ?>source/assets/img/user/user5.jpg" class="img-circle"-->
						<!--								alt=""> </span>-->
						<!--						<span class="subject">-->
						...
						<li class="dropdown dropdown-user">
							<a href="javascript:;" class="dropdown-toggle" data-bs-toggle="dropdown"
								data-hover="dropdown" data-close-others="true">
								<img alt="" class="img-circle " src="<?php echo base_url(); ?>source/assets/img/dp.jpg" />
							</a>
