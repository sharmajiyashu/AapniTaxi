                           ...
                           <div class="accordion accordion-flush" id="accordionFlushExample">
                              <div class="accordion-item">
                                 ...
                                 <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                    <form method="POST" enctype="multipart/form-data" action="<?= base_url('admin/Owner/basicDetail'); ?>/<?= isset($data['id']) ? $data['id'] : ''; ?>">
                              ...
                              <div class="accordion-item">
                                 ...
                                 <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                                    <form method="post" action="<?= base_url('admin/Owner/addressDetail'); ?>/<?= isset($data['id']) ? $data['id'] : ''; ?>" >
                                       <div class="card-body row">
                                          <div class="col-lg-6 p-t-20">
                                             <div
                                                class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                          ...
                                          <div class="col-lg-6 p-t-20">
                                             <div
                                                class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                <select name="city" class="mdl-textfield__input" id="city">
                                                   <option value="">Select City</option>
                                                   <?php foreach($city as $citi){ ?>
                                                   <option <?php if (isset($data['city']) && isset($citi) && $data['city'] == $citi['id']) echo "selected"; ?> value="<?php echo  $citi['id']; ?>">
                                                      <?php echo $citi['name']; ?>
                                                   </option>
                                                   <?php } ?>
                                                </select>
                                                <div><font color="#f00000" size="2px"><?php if (isset($error['city'])) echo $error['city']; ?></font></div>
                                             </div>
                                          </div>
                                          <div class="col-lg-12 p-t-20 text-center">
                                             <button type="submit"
                              ...
                              <div class="accordion-item">
                                 ...
                                 <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                                    <form method="post" enctype="multipart/form-data" action="<?= base_url('admin/Owner/drivingLicence'); ?>/<?= isset($data['id']) ? $data['id'] : ''; ?>">
                                       <div class="card-body row">
                                          <div class="col-lg-6 p-t-20">
                                             <div
                                                class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                              ...
                              <!--      <form enctype="multipart/form-data" method="post" action="<?= base_url('admin/Owner/accidentDetail'); ?>/<?= isset($data['id']) ? $data['id'] : ''; ?>">-->
                              <!--         <div class="card-body row">-->
                              <!--            <div class="col-lg-6 p-t-20">-->
                              <!--               <div-->
                              <!--                  class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">-->
                              <!--                  <select name="met_accident" class="mdl-textfield__input">-->
                              <!--                     <option value="">Select Met Accident</option>-->
                              <!--                     <option value="Yes" <?php if (isset($data['met_accident']) && $data['met_accident'] == 'Yes') echo "selected"; ?> >Yes</option>-->
                              <!--                     <option value="No" <?php if (isset($data['met_accident']) && $data['met_accident'] == 'No') echo "selected"; ?> >No</option>-->
                              <!--                  </select>-->
                              <!--                  <div><font color="#f00000" size="2px"><?php if (isset($error['met_accident'])) echo $error['met_accident']; ?></font></div>-->
                              <!--               </div>-->
                              <!--            </div>-->
                              <!--            <div class="col-lg-6 p-t-20">-->
                              <!--               <div-->
                              <!--                  class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">-->
                              <!--                  <input class="mdl-textfield__input" type="text" id="accident_description" name="accident_description" >-->
                              <!--                  <label class="mdl-textfield__label">Accident Description</label>-->
                              <!--               </div>-->
                              <!--            </div>-->
                              <!--            <div class="col-lg-6 p-t-20">-->
                              <!--               <div-->
                              <!--                  class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">-->
                              <!--                  <select name="is_criminal_case" class="mdl-textfield__input">-->
                              <!--                     <option value="">Select Criminal Case</option>-->
                              <!--                     <option value="Yes" <?php if (isset($data['is_criminal_case']) && $data['is_criminal_case'] == 'Yes') echo "selected"; ?> >Yes</option>-->
                              <!--                     <option value="No" <?php if (isset($data['is_criminal_case']) && $data['is_criminal_case'] == 'No') echo "selected"; ?> >No</option>-->
                              <!--                  </select>-->
                              <!--                  <div><font color="#f00000" size="2px"><?php if (isset($error['is_criminal_case'])) echo $error['is_criminal_case']; ?></font></div>-->
                              <!--               </div>-->
                              <!--            </div>-->
                              <!--            <div class="col-lg-6 p-t-20">-->
                              <!--               <div-->
                              <!--                  class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">-->
                              <!--                  <input class="mdl-textfield__input" type="text" id="criminal_description" name="criminal_description">-->
                              <!--                  <label class="mdl-textfield__label">Criminal Description</label>-->
                              <!--                  <div><font color="#f00000" size="2px"><?php if (isset($error['criminal_case_pending'])) echo $error['criminal_case_pending']; ?></font></div>-->
                              <!--               </div>-->
                              <!--            </div>-->
                              <!--            <div class="col-lg-6 p-t-20">-->
                              <!--               <div-->
                              <!--                  class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">-->
                              <!--                  <input class="mdl-textfield__input" type="text" id="criminal_case_pending" name="criminal_case_pending">-->
                              <!--                  <label class="mdl-textfield__label">Criminal Case Pending</label>-->
                              <!--               </div>-->
                              <!--            </div>-->
                              <!--            <div class="col-lg-12 p-t-20 text-center">-->
                              <!--               <button type="submit"-->
                              ...
                              <!--      <form method="post" enctype="multipart/form-data" action="<?= base_url('admin/Owner/policeVerification'); ?>/<?= isset($data['id']) ? $data['id'] : ''; ?>">-->
                              <!--         <div class="card-body row">-->
                              <!--            <div class="col-lg-6 p-t-20">-->
                              <!--               <div-->
                              <!--                  class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">-->
                              <!--                  <input class="mdl-textfield__input" type="text" id="police_verification_number" name="police_verification_number" value="<?= isset($data['police_verification_number']) ? $data['police_verification_number'] : ''; ?>">-->
                              <!--                  <label class="mdl-textfield__label">Police Verification Number</label>-->
                              <!--                  <div><font color="#f00000" size="2px"><?php if (isset($error['police_verification_number'])) echo $error['police_verification_number']; ?></font></div>-->
                              <!--               </div>-->
                              <!--            </div>-->
                              <!--            <div class="col-lg-6 p-t-20">-->
                              <!--               <div-->
                              <!--                  class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width mdl-textfield--file">-->
                              <!--                  <input type="file" class="form-control" id="police_verification_image" name="police_verification_image" >-->
                              <!--                  <div><font color="#f00000" size="2px"><?php if (isset($error['police_verification_image'])) echo $error['police_verification_image']; ?></font></div>-->
                              <!--               </div>-->
                              <!--            </div>-->
                              <!--            <div class="col-lg-12 p-t-20 text-center">-->
                              <!--               <button type="submit"-->
                              ...
                              <div class="accordion-item">
                                 ...
                                 <div id="flush-collapseSix" class="accordion-collapse collapse" aria-labelledby="flush-headingSix" data-bs-parent="#accordionFlushExample">
                                    <form method="post" action="<?= base_url('admin/Owner/documentDetails'); ?>/<?= isset($data['id']) ? $data['id'] : ''; ?>" enctype="multipart/form-data">
                                    <div class="card-body row">
                                       <div class="col-lg-6 p-t-20">
                                          <div
                                             class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                       ...
                                       <!--   <div-->
                                       <!--      class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">-->
                                       <!--      <input class="mdl-textfield__input" type="text" id="vid_number" name="vid_number" value="<?= isset($data['vid_number']) ? $data['vid_number'] : ''; ?>">-->
                                       <!--      <label class="mdl-textfield__label">Voter Id Number</label>-->
                                       <!--      <div><font color="#f00000" size="2px"><?php if (isset($error['vid_number'])) echo $error['vid_number']; ?></font></div>-->
                                       <!--   </div>-->
                                       <!--</div>-->
                                       <!--<div class="col-lg-6 p-t-20">-->
                                       <!--   <div-->
                                       <!--      class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width mdl-textfield--file">-->
                                       <!--      <input type="file" class="form-control" id="vid_image" name="vid_image" >-->
                                       <!--   </div>-->
                                       <!--</div>-->
                                       <?php 
                                       ...
                                       <div class="col-lg-6 p-t-20">
                                          <div
                                             class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width mdl-textfield--file">
                                             <input type="file" class="form-control" id="pan_image_back" name="pan_image_back" >
