								...
								<div class="col-lg-3 col-md-3 col-sm-12 col-12">
									<div class="info-box card-2">
										...
										<div class="info-box-content">
											...
											<span class="info-box-number"><?php echo isset($driver) ? Count($driver) : ''; ?></span>
											<div class="progress">
												<div class="progress-bar width-0"></div>
											</div>
										</div>
								...
								<div class="col-lg-3 col-md-3 col-sm-12 col-12">
									<div class="info-box card-3">
										<span class="info-box-icon push-bottom"><i
												class="material-icons">person</i></span>
										<div class="info-box-content">
											<span class="info-box-text">Today Driver</span>
											<span class="info-box-number"><?php echo isset($today_driver) ? $today_driver : ''; ?></span>
											<div class="progress">
												<div class="progress-bar width-0"></div>
											</div>
										</div>
								...
								<div class="col-lg-3 col-md-3 col-sm-12 col-12">
									<div class="info-box card-4">
										...
										<div class="info-box-content">
											...
											<span class="info-box-number"><?php echo isset($total_cab) ? $total_cab : ''; ?></span>
											<div class="progress">
												<div class="progress-bar width-0"></div>
											</div>
										</div>
								...
								<div class="col-lg-3 col-md-3 col-sm-12 col-12">
									<div class="info-box card-4">
										...
										<div class="info-box-content">
											...
											<span class="info-box-number"><?php echo isset($today_cab) ? $today_cab : ''; ?></span>
											<div class="progress">
												<div class="progress-bar width-0"></div>
											</div>
										</div>
								...
								<div class="card-body ">
								    <div class="row p-b-20">
                                        <div class="col-md-2 col-sm-2 col-2">
                                            <div class="btn-group">
                                                 <?php  $owner_id = $this->uri->segment(4);  ?>
                                                <a href="<?php echo base_url('admin/Owner/addVehicle/?id='.$owner_id); ?>"><button class="btn btn-info">Add Vehicle</button></a>
                                             </div>
                                        </div>
                                    </div>  
							...
							<div class="card  card-box">
								...
								<div class="card-body ">
								    <div class="row p-b-20">
                                        <div class="col-md-2 col-sm-2 col-2">
                                            <div class="btn-group">
                                                <a href="<?php echo base_url('admin/Owner/addDriver/?id='.$owner_id); ?>"><button class="btn btn-info">Add Driver</button></a>
                                             </div>
                                        </div>
                                    </div>  
									<div class="table-wrap">
										<div class="table-responsive tblDriverDetail">
										    <button onclick="ExportToExcel('xlsx')" class="btn btn-primary" style="margin-left: 12%;">Export</button>
											<table class="table display product-overview mb-30" id="support_table5">
												<thead>
													<tr>
														<th>No</th>
