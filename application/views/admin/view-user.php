                                        ...
                                        <tbody>
                                          <?php foreach($data as $key => $val){ ?>
                                            <tr>
                                                ...
                                                <td><a href="<?php echo base_url('admin/User/invoice/'); ?><?php echo isset($val['invoice']) ? $val['invoice'] : ''; ?>"><span style="color:#bf5de3;">View Bill</span></a></td>
                                            </tr>
                                        <?php } ?>
                                        </tbody>
                                    </table>
