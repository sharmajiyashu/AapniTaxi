				...
				<div class="page-content">
					...
					<?php } ?>
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Add Cab Category</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
										href="index-2.html">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li><a class="parent-item" href="#">Cab Category</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								<div class="card-head">
									<header>Add Cab Category</header>
								...
								<form method="POST" action="<?= base_url('admin/CabCategory/add'); ?>/<?= isset($data['id']) ? $data['id'] : ''; ?>">
								<div class="card-body row">
									...
									<div class="col-lg-6 p-t-20">
										<div
											...
											<select name="parent_id" class="mdl-textfield__input" id="parent_id" >
												 <option value="">Select Category</option>
												 <?php if(!empty($allMainCategory)) :
													foreach($allMainCategory as $key => $val) : ?>
												 <option value="<?= $val['id']; ?>" <?php if(isset($data['name']) && $val['name'] == $data['name']) echo 'selected';  ?> ><?= $val['name']; ?></option>
									...
									<div class="col-lg-6 p-t-20">
										<div
											...
											<label class="mdl-textfield__label">Cab Category Name</label>
											<div><font color="#f00000" size="2px"><?php if (isset($error['name'])) echo $error['name']; ?></font></div>
										</div>
									</div>
