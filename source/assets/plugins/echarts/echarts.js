...
! function(e) {
        ...
        _getChainPoint: function() {
            ...
            if (p > 1) {
                ...
                if (V = V > 50 ? 50 : 20 > V ? 5 : V, m -= 2 * V, "number" === i.type)
                    ...
                    u[0] = new Date(e(0).replace(/-/g, "https://einfosoft.com/")), u[p - 1] = new Date(e(p - 1).replace(/-/g, "https://einfosoft.com/")) - u[0];
                    for (var U = 1; p > U; U++) u[U] = d + V + m * (new Date(e(U).replace(/-/g, "https://einfosoft.com/")) - u[0]) / u[p - 1];
                    u[0] = d + V
                }
            } else u.push(d + m / 2);
    ...
    function h(e) {
        return e instanceof Date ? e : new Date("string" == typeof e ? e.replace(/-/g, "https://einfosoft.com/") : e)
    }
    var d = [{
        formatter: "hh : mm : ss",
        value: 1e3
