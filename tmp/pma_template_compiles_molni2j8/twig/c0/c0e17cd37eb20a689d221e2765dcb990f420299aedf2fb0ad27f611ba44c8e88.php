...
($context["allow_user_drop_database"] ?? null)));
    ...
    {
        return new Twig_Source("", "server/databases/databases_header.twig", "/usr/local/cpanel/base/3rdparty/phpMyAdmin/templates/server/databases/databases_header.twig");
    }
}
